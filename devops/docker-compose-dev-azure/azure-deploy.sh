...
resourcename="bakerymanagementsystem"  # lower case, only
resourcegroup="bakerymanagementsystem_rg"
...
# git clone https://github.com/apilogicserver/bakerymanagementsystem.git
...
az group create --name bakerymanagementsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group bakerymanagementsystem_rg --sku S1 --is-linux
az container create --resource-group bakerymanagementsystem_rg --name bakerymanagementsystem --image apilogicserver/bakerymanagementsystem:latest --dns-name-label bakerymanagementsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//bakerymanagementsystem.westus.azurecontainer.io:5656'
